...
public class ChinaDate {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(ChinaDate.lunarToSolar("1990-12-04", false));
        System.out.println(ChinaDate.lunarToSolar("1984-10-21", true));
        System.out.println(ChinaDate.lunarToSolar("1990-12-25", false));
        System.out.println("************");
        System.out.println(ChinaDate.solarToLunar("1900-09-23", true));
        System.out.println(ChinaDate.solarToLunar("1900-09-24", true));
        System.out.println(ChinaDate.solarToLunar("1900-10-22", true));
        System.out.println(ChinaDate.solarToLunar("1900-10-23", true));
        System.out.println(ChinaDate.solarToLunar("1991-02-09", true));

        System.out.println(ChinaDate.solarToLunar("1990-06-30", true));
        System.out.println(ChinaDate.solarToLunar("1984-12-13", true));
        System.out.println(ChinaDate.solarToLunar("1991-01-19", true));
    }
}
