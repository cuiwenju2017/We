...
public class GamesFragment extends Fragment {
    ...
    Unbinder unbinder;
    @BindView(R.id.rl_aircraft_battle)
    RelativeLayout rlAircraftBattle;
    ...
    @OnClick({R.id.rl_ball, R.id.rl_hero, R.id.rl_aircraft_battle})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.rl_ball://滚动的球球
...
//        intent.putExtra("url", "file:///android_asset/gunqiu.html");
            ...
            case R.id.rl_hero://方块英雄
                ...
                startActivity(intent);
                break;
            case R.id.rl_aircraft_battle://飞机大战
